    ...
    <div className="w-full">
      ...
      <div className="bg-white">
        ...
        <div className="max-w-7xl px-4 mx-auto gap-12 flex flex-row mb-8">
          ...
          <div className="basis-1/2">
            ...
            <p className="mb-6">
              Life is full of competing priorities, making it difficult to decide where to direct your energy. The Self-Care Compass helps cut through the noise by pinpointing the life domain most in need of attention. This clarity allows you to focus on the area that will have the greatest impact on your overall well-being.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl px-4 mx-auto gap-12 flex flex-row pb-16">
          <div className="basis-1/2">
            ...
            <p className="mb-4">
              By identifying where to begin, the Self-Care Compass empowers you to take meaningful steps toward improving balance and well-being in your life. It’s the first step to aligning your self-care practices with your evolving values, ensuring that your efforts are intentional, impactful, and rooted in what matters most to you. The Self-Care Compass score is calculated using your Values, Negative Impact, and Detection ratings...
            </p>
          </div>
          <div className="basis-1/2">
              <Image src ={Target} alt="Target Starting Point with the Self-Care Compass" className="rounded-lg"/>
          </div>
        </div>

      </div>

      {/* Self-Care Compass Calculation Section */}
      <div className="bg-stone-50">
        <div className="grid place-content-center max-w-7xl mx-auto pt-16 text-center pb-16">
          <Image src = {Calculation} alt="Self-Care Compass Calculation Model" />
          <h4 className="text-xl font-bold">Score = Value x Impact x Detection</h4>
      ...
      <div className="bg-stone-700">
        <div className="max-w-7xl px-4 mx-auto pt-16 pb-16">
          <Image src = {Mockup} alt="Self-Care Compass Screen Mockup" className="pb-4"/>
          <h4 className="text-2xl mb-4 text-evergreen-200">Referring to the tool consistently</h4>
          <p className="mb-4 text-white">Higher LDPN indicate higher-priority domains that require immediate action, while lower scores suggest less critical domains. The Self-Care Compass helps prioritize efforts to mitigate the most significantly affected domains based on your personal values and their negative impact. The Self-Care Compass is intended to be used multiple times during The YOU Continuum, as values, beliefs, and needs change over time.</p>
          <p className="mb-6 text-white">The Self-Care Compass does all the scoring for you and provides immediate results, showing you which zone you are currently in for each life domain!</p>
          <button onClick={handleStart} className="px-6 py-3 bg-evergreen-400 hover:bg-evergreen-500 active:bg-evergreen-600 text-white text-sm font-medium rounded-[40px] shadow hover:bg-green-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 transition duration-150 ease-in-out">
            Get started with the Self-Care Compass
          </button>
        </div>
      </div>
